    ...
    <div class="forgot-desktop forgot-mobile">
        <div class="forgot">
            ...
            <form @submit.prevent="handleNewPassword" class="forgot-desktop-field">
                ...
                <div class="password">
                    <InputComponent type="password" name="password" placeHolder="New Password (8+ character required)" :handleInput="handleUserInput" />
                </div>
                
                <div class="reEnter-password">
                    <InputComponent type="password" name="confirmPass" placeHolder="Re-Enter Password" :handleInput="handleUserInput" />
                </div>

                <div class="desk-links">
                    <button type="submit" class="flex-center-row login-btn"> Log in
    ...
    export default {
        ...
        methods: {
            ...
            handleNewPassword(){
                ...
                user.append('confirmPass', this.inputData.confirmPass)

                axios.put(`${BASE_URL}/jobSeeker/password`, user)
                .then(res => {
